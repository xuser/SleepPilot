...
public class SupportVectorMaschineController {
    ...
    /**
     * True, if you want to activate the trainigsMode and false, if you want to
     * classify with the current model.
     */
    ...
    public void start() {
        ...
        if (trainMode == true) {
            ...
            int dataCount = respectiveFeatureExtractionModel.getNumberOfFeatures();
...
//			}
            ...
            for (int i = 0; i < respectiveFeatureExtractionModel.getNumberOfFeatures(); i++) {
                ...
                for (int y = 1; y < (respectiveFeatureExtractionModel.getNumberOfChannels() + 1); y++) {
                    ...
                    double tmp = (double) respectiveFeatureExtractionModel.getFeature(i, y);
                    if (tmp != 0.0) {
