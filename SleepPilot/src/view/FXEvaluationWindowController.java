...
public class FXEvaluationWindowController implements Initializable {
    ...
    private Label nPer;
    @FXML
    private Label remPer;
    @FXML
    private Label artefactPer;
    @FXML
    private Label arrousalPer;
    @FXML
    private Label stimulationPer;

    @FXML
    private Label awakeMin;
    @FXML
    private Label s1Min;
    @FXML
    private Label s2Min;
    ...
    private Label nMin;
    @FXML
    private Label remMin;
    @FXML
    private Label artefactMin;
    @FXML
    private Label arrousalMin;
    @FXML
    private Label stimulationMin;
