...
public class RawDataModel implements Serializable {
     ...
     *
     * @param row the row from where you want to get the value
     * @param channel the channel from where you want to get the value
     ...
     *
     * This method returns a value from a specific position in the data points.
     * IMPORTANT: Just use this function for filtering and not, if you want to
     * print the value!
     *
     * @param row the row from where you want to get the value
     * @param channel the channel from where you want to get the value
     ...
     *
     * @param numberOfEpoch the row from which on the needed values have to be
     * returned.
     * @param channel the channel from which the List have to be returned
     * @return a list of double values of all samples from one 30s epoch.
     */
