...
public class FXHypnogrammController implements Initializable{
	 ...
	 * Basis constructor
	 * 
	 * @param dataPointsModel
	 * 					initial instance of raw model
	 * @param featureExtractionModel
	 * 					initial instance of feature extraction model
	 * @param viewModel
	 * 				initial instance of view model
	 * 				
	 */
...
//					stage.close();
	 ...
	 * @param currentEpoch
	 * 				the epoch you want to set the marker to
	 */
