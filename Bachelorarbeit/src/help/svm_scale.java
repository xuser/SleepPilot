...
/**
 * This class sclaes the feature extraction values to a normalized range. This
 * class comes form the LIVSVM framework, but has been modified by the named
 * author.
 *
 * @author Nils Finke
 */
...
//	}
     ...
     *
     * @param value class label which have to be scaled or saved.
     */
...
//		System.out.print(value + " ");
     ...
     *
     * @param index position in feature vector. First index is 1.
     * @param value the scaled value, which have to be stored.
     */
    private void output(int index, double value, int row) {
        ...
        respectiveFeatureExtractionModel.setFeature(row, index, (float) (value));
